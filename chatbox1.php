...
<div class="login-html scorecard">
    ...
    <header>
      <div class="scorecard-header"><br>
        ...
        <div class="row">
          ...
          <div class="col-xs-5">
            <input type="text" placeholder="Away Team" value="" disabled>
          </div>
        </div>
      </div>
    </header>
    ...
    <div class="score-area">
      ...
      <div class="row">
        <div class="col-xs-5">
          <input type="text" name="" value="'.$_SESSION["name_store"].'">
        </div>
        <div class="col-xs-2">
          Skip
        </div>
        <div class="col-xs-5">
          <input type="text" name="" value="'.$_SESSION["fname"].'">
        </div>
      </div>
      <div class="row hide">
        <div class="col-xs-5">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" value="0" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="3" id="pts3" pattern="\d*" disabled>
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="5" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="7" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="9" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="11" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="13" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="15" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="17" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="19" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="21" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="23" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="25" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="27" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="29" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="31" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
      ...
      <div class="row">
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="33" class="pts h" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
        ...
        <div class="col-xs-5">
          <div class="row">
            <div class="col-xs-6 group-pts">
              <input type="text" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');" name="35" class="pts a" pattern="\d*">
            </div>
            <div class="col-xs-6 group-pts">
